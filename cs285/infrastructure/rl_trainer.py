...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        # (returns self.env.spec.max_episode_steps if  self.params['ep_len']==0, otherwise returns self.params['ep_len'])
        ...
        ## DONE initialize all of the TF variables (that were created by agent, etc.)
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            training_returns = self.collect_training_trajectories(itr,
                                ...
                                self.params['batch_size']) ## DONE implement this function below
            paths, envsteps_this_batch, train_video_paths = training_returns
            self.total_envsteps += envsteps_this_batch

            # relabel the collected obs with actions from a provided expert policy
            if relabel_with_expert and itr>=start_relabel_with_expert:
                # This function modifies paths variable!
                self.do_relabel_with_expert(expert_policy, paths) ## DONE implement this function below
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        ...
        # DONE decide whether to load training data or use
        ...
        # DONE collect data to be used for training
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            ob_batch, ac_batch, re_batch, next_ob_batch, terminal_batch = self.agent.sample(self.params['train_batch_size']) # DONE
