...
class DQNCritic(BaseCritic):
    ...
    def _build(self, q_func):
        ...
        target_q_t = self.rew_t_ph+self.gamma*q_tp1*(1-self.done_mask_ph) # DONE
        ...
        self.total_error = tf.reduce_mean(huber_loss(q_t - target_q_t)) # DONE
        ...
        q_func_vars = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope='q_func') # DONE
        target_q_func_vars = tf.get_collection(tf.GraphKeys.TRAINABLE_VARIABLES, scope='target_q_func') # DONE
