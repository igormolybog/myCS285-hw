...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        return [sum([r*(self.gamma**t) for t, r in enumerate(rewards)])]*(len(rewards))
    ...
    def _discounted_cumsum(self, rewards):
        ...
        return [sum([r*(self.gamma**(tdash)) for tdash, r in enumerate(rewards[t:])]) for t in range(len(rewards))]

        # we're coding in Python, guys.. not in C..
